...
export default function Projects() {
  ...
  const renderProjects = (projectsList: Project[], category: string, ulIndex: number) => (
    <>
  ...
  return (
    <> 
      ...
      <div className="pt-5 pb-20 overflow-hidden">
        {renderProjects(projects.freelance, 'Freelance', 0)}
        {renderProjects(projects.personal, 'Personal', 1)}
        {renderProjects(projects.juno, 'Juno College', 2)}
      </div>
    </>
  );
};