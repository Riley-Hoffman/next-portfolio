...
export const projects: Project[] = [
    ...
    },
    {
      ...
      imgUrl: `${particleCleanup.src}?v=1.1`,
    ...
    },
    {
      ...
      imgUrl: `${infinityCorkboard.src}?v=1.1`,
