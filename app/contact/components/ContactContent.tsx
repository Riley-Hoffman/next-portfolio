...
export const ContactContent = ({ errors }: ContactContentProps) => (
  <div className="contact-content border-accenttwo mb-10 min-h-64 max-w-[calc(100%-1.563rem)] rounded-t-md bg-heading shadow-[0.188rem_0.125rem_0_0] shadow-accentone-300 dark:shadow-accentone-200">
    {errors.length === 0 && (
      <>
