...
export default function Accessibility() {
    return (
        <>     
            <SchemaOrg headline="Accessibility - Riley Hoffman - Web Developer" description="As a dedicated web developer, I am committed to creating an accessible and inclusive website experience for all users." image="https://storage.googleapis.com/rileyhoffmandotcom.appspot.com/thumbnail.jpg" datePublished="2024-07-04T09:25:01.340Z" />     
