...
export default function Faq() {
    return (
        <>
            <SchemaOrg headline="FAQ - Riley Hoffman - Web Developer" description="Find the answers to my most frequently asked questions." image="https://storage.googleapis.com/rileyhoffmandotcom.appspot.com/thumbnail.jpg" datePublished="2024-07-04T09:25:01.340Z" />
