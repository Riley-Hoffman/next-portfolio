    ...
    <div className="max-w-screen-xl">
        <div className="items-center md:flex">
            <div className="min-h-96 md:w-1/3">
                <Image className="size-96 max-w-full object-cover border-x-2 clip-path-cut-corners" src="/api/optimize-image?path=/headshot.webp&width=384&format=webp" alt="Riley with a flower behind his ear. Shot in black and white." width="384" height="452" priority={false} />
            </div>
