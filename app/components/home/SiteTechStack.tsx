      ...
      >
        {technologies.map((tech) => (
          <li key={tech.name} className="relative overflow-hidden pt-8">
            <a
              className="mx-auto block min-h-[9.5rem] w-fit min-w-[13.1rem] rounded-md bg-pink-100 p-5 no-underline duration-0 md:tool-tip after:-z-10 focus-visible:bg-zinc focus-visible:text-pink-100 md:before:left-1 md:before:inline-block md:before:h-0 md:before:border-0 md:before:pl-[0.313rem] md:before:font-fontawesomesolid md:before:text-[63%] md:before:font-normal md:before:duration-0 md:before:content-['\\f08e'] md:after:h-0 md:after:w-full md:after:rounded-bl-none md:after:rounded-br-none md:after:bg-pink-100 md:after:py-0 md:after:text-center md:after:leading-5 md:after:opacity-100 md:after:transition-[height,padding-bottom] md:after:content-['Opens_new_window'] md:hover:rounded-tl-none md:hover:rounded-tr-none md:hover:bg-zinc md:hover:text-pink-100 md:hover:after:h-[1.813rem] md:hover:after:bg-zinc md:hover:after:py-[0.25rem] md:focus-visible:rounded-tl-none md:focus-visible:rounded-tr-none md:focus-visible:bg-zinc md:focus-visible:outline-none motion-safe:md:after:duration-500"
              href={tech.url}
              target="_blank"
