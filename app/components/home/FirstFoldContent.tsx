...
export const FirstFoldContent = () => (
  <>
    ...
    <p className="m-0 mr-auto motion-safe:animate-typetext">Web Developer</p>
    <p className="relative mx-5 mt-8 rounded-sm border border-bordercolor bg-[#f5eef6a3] px-4 py-3 font-medium leading-7 after:absolute after:-top-8 after:left-0 after:h-3 after:w-5 after:bg-accenttwo-200 dark:bg-[#0a110999] md:w-3/5">
