  ...
  return (
    ...
    >
      <figure itemScope itemType="https://schema.org/ImageObject">
        <Image
          className={`size-96 max-w-full rounded-3xl object-cover border ${LIGHT_BORDER} ${DARK_BORDER}`}
      ...
      <div className={`m-6 border-2 ${LIGHT_BORDER} bg-[whitesmoke] py-6 leading-7 contrast-more:bg-white ${DARK_BORDER} dark:bg-siteblack md:w-2/3 lg:px-[8%]`}>
        <h2>My Journey</h2>
        <p>
